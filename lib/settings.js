...
export const data = {
  ...
  hoverForOptions: { label: 'Hover for space options', type: 'checkbox' },
  ...
  agendaWidget: { label: 'Agenda', type: 'checkbox' },
  ...
  clickForCaffeinate: { label: 'Click for Caffeinate', type: 'checkbox' },
